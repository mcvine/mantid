...
/** Takes a 2D workspace as input and find the minimum in each 1D spectrum.
    The algorithm creates a new 1D workspace containing all minima as well as
   their X boundaries
...
public:
  ...
  const std::string summary() const override {
    return "Takes a 2D workspace as input and find the minimum in each 1D "
           ...
           "well as their X boundaries and error. "
           "This is used in particular for single crystal as a quick way to "
           "find strong peaks.";
  }
